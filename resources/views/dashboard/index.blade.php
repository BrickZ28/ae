                ...
                <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                <!--begin::Amount-->
                                <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{$users->count()}}</span>
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
                        ...
                        <div class="card-body d-flex flex-column justify-content-end pe-0">
                            <!--begin::Title-->
                            <span class="fs-6 fw-bolder text-gray-800 d-block mb-2">Newest Members</span>
                            <!--end::Title-->
                            <!--begin::Users group-->
                    ...
                    <div class="card card-flush h-lg-50">
                        ...
                        <div class="card-header pt-5 ">
                            <!--begin::Title-->
                            <h3 class="card-title text-gray-800 fw-bold">Top Donators</h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                        ...
                        <div class="card-body pt-5">
                            @foreach($top_donators as $top_donator)
                                <!--begin::Item-->
                                <div class="d-flex flex-stack">
                                    <!--begin::Section-->
                                    <a href="#" class="text-primary fw-semibold fs-6
                                    me-2">{{$top_donator->payer->userProfile->global_name}}</a>
                                    <!--end::Section-->
                                    <!--begin::Action-->
                                    @checkRole(['Me', 'In the Shadows'])
                                    Total: ${{$top_donator->total_amount}} <br>
                                    @endcheckRole
                                    <!--end::Action-->
                                    Number of Donates: {{$top_donator->total_transactions}}
                                </div>
                                <!--end::Item-->
                                <!--begin::Separator-->
...
{{--                                </div>--}}
                    ...
                    <div class="card card-flush h-lg-50">
                        ...
                        <div class="card-header pt-5 ">
                            <!--begin::Title-->
                            <h3 class="card-title text-gray-800 fw-bold">Last Donators</h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
{{--                            <div class="card-toolbar">--}}
{{--                                <!--begin::Menu-->--}}
                        ...
                        <div class="card-body pt-5">
                            @foreach($last_transactions as $last_transaction)
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--begin::Action-->
                                    @checkRole(['Me', 'In the Shadows'])
                                    Total: ${{$last_transaction->amount}} <br>
                                    @endcheckRole
                                    <!--end::Action-->
                                    Date: <x-display-date-formatted
                                        :date="$last_transaction->updated_at" format="D M j, Y @ g:i:sa"/>
                                    <!--end::Action-->
                                </div>
                                <!--end::Item-->
                                <!--begin::Separator-->
