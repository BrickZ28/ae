                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                            ...
                                            <option value="Analyst">Tribe</option>
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                                <div class="fw-bold text-gray-800">Tribe</div>
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="kt_modal_update_role_option_2">
                                                                <div class="fw-bold text-gray-800">people</div>
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Discord Name</th>
                            <th class="min-w-125px">Role</th>
                            <th class="min-w-125px">Last login</th>
                            <th class="min-w-125px">Tribe</th>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="apps/user-management/users/view.html" class="text-gray-800
                                ...
                                <td>Administrator</td>
                                <td>
                                    <div class="badge badge-light fw-bold"><x-display-date-formatted
                                            :date="$user->last_login" format="D M j, Y @ g:i:sa" /></div>
                                </td>
                                <td></td>
