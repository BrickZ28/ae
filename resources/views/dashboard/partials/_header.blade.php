...
<div id="kt_app_header" class="app-header"
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{route('landing.index')}}" class="d-lg-none">
                <img alt="Logo" src="{{asset('assets/media/logos/rocky.gif')}}" class="h-30px"/>
            </a>
        </div>
        <!--end::Mobile logo-->
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    fs-5">{{$user->userProfile->global_name}}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1
                                        ms-2">{{$user->ae_credits}} AE Credits</span>
                                    </div>
