                        ...
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                ...
                                <a href="#" class="d-block mw-150px ms-sm-auto">
                                    <img alt="Logo" src="{{asset('assets/media/logos/aeg_icon_fire.gif')}}" class="w-100" />
                                </a>
                                <!--end::Logo-->
                                <!--begin::Text-->
...
{{--                                </div>--}}
                        ...
                        <div class="pb-12">
                            ...
                            <div class="d-flex flex-column gap-7 gap-md-10">
                                <!--begin::Message-->
                                <div class="fw-bold fs-2">Dear {{auth()->user()->username}},</div>
                                ...
                                <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                                    <div class="flex-root d-flex flex-column">
                                        ...
                                        <span class="fs-5">#{{$transaction->id}}</span>
                                    </div>
                                    <div class="flex-root d-flex flex-column">
                                        <span class="text-muted">Date</span>
                                        <span class="fs-5"><x-display-date-formatted
                                                :date="$transaction->created_at" format="D M j, Y @ g:i:sa" /></span>
                                    </div>
                                    <div class="flex-root d-flex flex-column">
