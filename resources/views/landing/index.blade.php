...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="AfterEarth Gaming" />
    <meta name="keywords" content="Ark, ASE, ASA, Afterearth, Xbox, playstation, pc, gaming, steam" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="AfterEarth Gaming" />
    <meta property="og:url" content="{{config('app.url')}}" />
    <meta property="og:site_name" content="AfterEarth Gaming" />
...
{{--<script>var defaultThemeMode = "dark"; var themeMode; if ( document.documentElement ) { if ( document.documentElement--}}
{{--        .hasAttribute("data-bs-theme-mode")) { themeMode = document.documentElement.getAttribute("data-bs-theme-mode"); } else { if ( localStorage.getItem("data-bs-theme") !== null ) { themeMode = localStorage.getItem("data-bs-theme"); } else { themeMode = defaultThemeMode; } } if (themeMode === "system") { themeMode = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"; } document.documentElement.setAttribute("data-bs-theme", themeMode); }</script>--}}
...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    ...
    <div class="mb-0" id="home">
        <!--begin::Wrapper-->
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom custom-landing-dark-bg" style="background-image: url(assets/media/logos/aegbanner.png)">
            <!--begin::Header-->
