                        ...
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                                ...
                                <div class="w-100 mb-10">
                                    ...
                                    <div class="d-flex flex-stack mb-5">
                                                <span
                                                    class="fw-semibold fs-6 text-gray-800">Keen Analytics Platform</span>
                                    ...
                                    <div class="d-flex flex-stack mb-5">
                                                <span
                                                    class="fw-semibold fs-6 text-gray-800">Targets Timelines & Files</span>
                                        <i class="ki-outline ki-cross-circle fs-1"></i>
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                        ...
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-primary py-20 px-10">
                                ...
                                <div class="w-100 mb-10">
                                    ...
                                    <div class="d-flex flex-stack">
                                                <span
                                                    class="fw-semibold fs-6 text-white opacity-75">Unlimited Projects</span>
                        ...
                        <div class="d-flex h-100 align-items-center">
                            ...
                            <div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                                ...
                                <div class="mb-7 text-center">
                                    ...
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="text-gray-500 fw-semibold mb-5">Best Settings for Enterprise
                                    </div>
                                    <!--end::Description-->
                                    <!--begin::Price-->
                                    <div class="text-center">
