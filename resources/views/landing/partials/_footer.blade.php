        ...
        <div class="container">
            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    <!--begin::Logo-->
                    <a href="/">
                        <img alt="Logo" src="assets/media/logos/AEG_Icon_lighting.gif" class="h-15px h-md-20px"/>
                    </a>
                    <!--end::Logo image-->
                    <!--begin::Logo image-->
                    <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1" href="/">&copy;2018 -
                        {{ date('Y') }} AfterEarth Gaming</span>
                    <!--end::Logo image-->
                </div>
                <!--end::Copyright-->
                <!--begin::Menu-->
