        ...
        <div
            ...
            <div class="menu-item">
                ...
                <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#how-it-works"
                   data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Rules</a>
                <!--end::Menu link-->
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item">
                ...
                <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#achievements"
                   data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Community stats</a>
                <!--end::Menu link-->
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item">
                ...
                <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#team"
                   data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Specials</a>
                <!--end::Menu link-->
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item">
                ...
                <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#portfolio"
                   data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Screen Shots</a>
                <!--end::Menu link-->
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item">
                ...
                <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#pricing"
                   data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Server Info</a>
                <!--end::Menu link-->
            </div>
            <!--end::Menu item-->
        </div>
